...
struct VertexInput {
    ...
    @location(1) cell_position: vec3<f32>,
    @location(2) cell_radius: f32,
...
fn vs_main(in: VertexInput) -> VertexOutput {
    ...
    let base_radius = clamp(in.aperture_params.x, 0.08, 0.65);
    ...
    let world_position = in.cell_position + quat_rotate(in.rotation, local);
