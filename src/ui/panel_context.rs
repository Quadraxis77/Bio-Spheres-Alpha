...
pub struct GenomeEditorState {
    ...
    pub cave_mesh_smoothing_iterations: u32,
    pub cave_mesh_smoothing_factor: f32,
    pub cave_mesh_smooth_normals: bool,
    pub cave_flat_ground_enabled: bool,
...
impl GenomeEditorState {
    ...
    pub fn new() -> Self {
        let (
            ...
            cave_mesh_smoothing_iterations,
            cave_mesh_smoothing_factor,
            cave_mesh_smooth_normals,
            cave_flat_ground_enabled,
            geothermal_enabled,
            geothermal_count,
    ...
    pub fn save_cave_settings(&self) {
        if let Err(e) = Self::save_cave_settings_to_file(
            ...
            self.cave_mesh_smoothing_iterations,
            self.cave_mesh_smoothing_factor,
            self.cave_mesh_smooth_normals,
            self.cave_flat_ground_enabled,
    ...
    fn save_cave_settings_to_file(
        ...
        mesh_smooth_normals: bool,
        flat_ground_enabled: bool,
    ...
    pub fn load_cave_settings() -> (
        ...
        struct CaveSettings {
            ...
            isolated_chunk_cull_volume: f32,
            #[serde(default = "default_mesh_smoothing_iterations")]
            mesh_smoothing_iterations: u32,
            #[serde(default = "default_mesh_smoothing_factor")]
            mesh_smoothing_factor: f32,
            #[serde(default)]
            mesh_smooth_normals: bool,
            #[serde(default)]
        ...
        fn default_mesh_smoothing_iterations() -> u32 {
            crate::rendering::cave_system::DEFAULT_MESH_SMOOTHING_ITERATIONS
        }
        fn default_mesh_smoothing_factor() -> f32 {
                ...
                Ok(contents) => match ron::from_str::<CaveSettings>(&contents) {
                    Ok(settings) => {
                        ...
                        return (
                            ...
                            settings.mesh_smoothing_iterations,
                            settings.mesh_smoothing_factor,
                            settings.mesh_smooth_normals,
                            settings.flat_ground_enabled,
