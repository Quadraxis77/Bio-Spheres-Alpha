...
pub struct CaveParams {
    ...
    pub rock_cool_color: [f32; 3],
    pub rock_warp_strength: f32,
    pub rock_warm_color: [f32; 3],
    pub rock_fine_band_strength: f32,
    pub rock_pale_color: [f32; 3],
    pub rock_cool_mottle_strength: f32,
    pub rock_grain_strength: f32,
    pub rock_patch_contrast: f32,
    pub rock_seam_darkening: f32,
    pub rock_wall_line_strength: f32,
    pub rock_min_color: f32,
    pub rock_max_color: f32,
    pub rock_ambient_strength: f32,
    pub rock_diffuse_strength: f32,
    pub rock_specular_strength: f32,
    pub rock_specular_power: f32,
    pub rock_texture_scale: f32,
    pub rock_coarse_frequency: f32,
    pub rock_fine_frequency: f32,
    pub rock_seam_frequency: f32,
    pub rock_fine_noise_scale: f32,
    pub rock_fine_noise_strength: f32,
    pub rock_seam_noise_scale: f32,
    pub rock_seam_noise_strength: f32,
    pub rock_coarse_band_low: f32,
    pub rock_coarse_band_high: f32,
    pub rock_fine_band_low: f32,
    pub rock_fine_band_high: f32,
    pub rock_seam_low: f32,
    pub rock_seam_high: f32,
...
impl Default for CaveParams {
    fn default() -> Self {
        Self {
            ...
            rock_cool_color: [0.150, 0.165, 0.160],
            rock_warp_strength: 1.85,
            rock_warm_color: [0.235, 0.205, 0.155],
            rock_fine_band_strength: 0.28,
            rock_pale_color: [0.330, 0.300, 0.225],
            rock_cool_mottle_strength: 0.22,
            rock_grain_strength: 0.09,
            rock_patch_contrast: 0.17,
            rock_seam_darkening: 0.28,
            rock_wall_line_strength: 0.65,
            rock_min_color: 0.045,
            rock_max_color: 0.48,
            rock_ambient_strength: 0.08,
            rock_diffuse_strength: 0.7,
            rock_specular_strength: 0.3,
            rock_specular_power: 32.0,
            rock_texture_scale: 0.05,
            rock_coarse_frequency: std::f32::consts::TAU,
            rock_fine_frequency: 22.0,
            rock_seam_frequency: 13.0,
            rock_fine_noise_scale: 0.045,
            rock_fine_noise_strength: 4.0,
            rock_seam_noise_scale: 0.035,
            rock_seam_noise_strength: 2.5,
            rock_coarse_band_low: -0.35,
            rock_coarse_band_high: 0.55,
            rock_fine_band_low: 0.35,
            rock_fine_band_high: 0.92,
            rock_seam_low: 0.82,
            rock_seam_high: 0.98,
