...
impl PostProcessRenderer {
    pub fn new(
        ...
        {
            let init: f32 = 1.0;
            exposure_buf.slice(..).get_mapped_range_mut()
        ...
        let bind_group = Self::make_bind_group(
            device, &layout, &params_buf, &exposure_buf, &scene_view, &sampler,
        );
    ...
    fn make_bind_group(
        ...
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry { binding: 1, resource: exposure.as_entire_binding() },
                wgpu::BindGroupEntry {
                    binding: 2,
    ...
    pub fn resize(&mut self, device: &wgpu::Device, width: u32, height: u32) {
        ...
        self.height = height;
        let (tex, view) =
            Self::create_scene_texture(device, width, height, self.surface_format);
        self.scene_texture = tex;
        self.scene_view    = view;
        self.bind_group = Self::make_bind_group(
            device, &self.layout, &self.params_buf,
            &self.exposure_buf, &self.scene_view, &self.sampler,
        );
    }
