...
impl GpuPhysicsPipelines {
    ...
    pub fn new(device: &wgpu::Device) -> Self {
        ...
        let signal_sense = Self::create_compute_pipeline(
            ...
            "main",
            &[&signal_flags_layout, &signal_sense_cell_data_layout, &signal_sense_world_data_layout],
            "Signal Sense",
        );
    ...
    pub fn create_cell_state_read_bind_group(
        ...
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry { binding: 19, resource: buffers.embryocyte_reserve_buffer.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 20, resource: buffers.mode_properties_v9.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 21, resource: buffers.mode_properties_v10.as_entire_binding() },
            ],
        })
    }
    ...
    pub fn create_cell_state_write_bind_group(
        ...
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry { binding: 39, resource: buffers.embryocyte_reserve_buffer.as_entire_binding() },
            ],
        })
    }
    ...
    pub fn create_cached_bind_groups(
        ...
        let dummy_cave_collision_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
        ...
        let signal_propagate_adhesion = self.create_signal_propagate_adhesion_bind_group(device, adhesion_buffers, buffers);
        ...
        let mode_switch_group0 = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                wgpu::BindGroupEntry { binding: 0, resource: buffers.cell_count_buffer.as_entire_binding() },
        ...
        if read_only {
            ...
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                ...
                entries: &[
                    ...
                    wgpu::BindGroupLayoutEntry { binding: 19, visibility: wgpu::ShaderStages::COMPUTE, ty: wgpu::BindingType::Buffer { ty: wgpu::BufferBindingType::Storage { read_only: false }, has_dynamic_offset: false, min_binding_size: None }, count: None },
            ...
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                ...
                entries: &[
                    ...
                    wgpu::BindGroupLayoutEntry { binding: 39, visibility: wgpu::ShaderStages::COMPUTE, ty: wgpu::BindingType::Buffer { ty: wgpu::BufferBindingType::Storage { read_only: false }, has_dynamic_offset: false, min_binding_size: None }, count: None },
                ],
            })
        }
    }
    ...
    fn create_env_adhesion_mode_data_bind_group(
        ...
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry { binding: 2, resource: triple_buffers.glueocyte_env_adhesion_flags.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 3, resource: triple_buffers.glueocyte_boulder_adhesion_flags.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 4, resource: triple_buffers.glueocyte_cell_adhesion_flags.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 5, resource: adhesion_buffers.signal_flags.as_entire_binding() },
            ],
        })
    }
    ...
    fn create_signal_propagate_adhesion_bind_group_layout(device: &wgpu::Device) -> wgpu::BindGroupLayout {
        device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
    ...
    fn create_signal_sense_cell_data_bind_group(
        ...
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some(&format!("Signal Sense Cell Data Bind Group {}", buffer_index)),
