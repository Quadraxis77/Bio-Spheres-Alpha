...
pub mod buffer_id {
    ...
    pub const LISTENER_RESPONSE: u32 = 15;
}
...
impl MutationSystem {
    pub fn new(device: &wgpu::Device, queue: &wgpu::Queue, cell_capacity: u32) -> Self {
        ...
        let collect_shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(
                include_str!("../../../shaders/mutation_collect_candidates.wgsl").into(),
            ),
        });
        ...
        let gc_shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(
                include_str!("../../../shaders/genome_gc.wgsl").into(),
            ),
        });
        ...
        let ref_count_sync_shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(
                include_str!("../../../shaders/genome_ref_count_sync.wgsl").into(),
            ),
        });
        ...
        let buffers_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            ...
            entries: &[
                ...
                // bindings 35-38: cell-specific listener property buffers
                Self::storage_rw_entry(35),
        ...
        let ref_count_sync_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
        ...
        let mode_offset_reset_shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(
                include_str!("../../../shaders/mode_offset_reset.wgsl").into(),
            ),
        });

        let mode_offset_reset_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
        ...
        let mode_offset_reset_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
        ...
        let mode_offset_reset_pipeline =
            device.create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
        ...
        let table_size =
            (vulnerability_table.len() * std::mem::size_of::<MutationParamEntry>()) as u64;
        ...
        queue.write_buffer(
            ...
            0,
            bytemuck::cast_slice(&vulnerability_table),
        );
    ...
    fn build_default_vulnerability_table() -> Vec<MutationParamEntry> {
        let mut entries = vec![
            ...
            MutationParamEntry {
                buffer_id: buffer_id::MODE_VISUALS,
                element_offset: 0xFF,
                weight: 1.0,
                min_delta: 0.0,
                max_delta: 0.0,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::PARENT_MAKE_ADHESION,
                element_offset: 0,
                weight: 3.0,
                min_delta: 0.0,
                max_delta: 0.0,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::CHILD_A_KEEP_ADHESION,
                element_offset: 0,
                weight: 0.5,
                min_delta: 0.0,
                max_delta: 0.0,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::CHILD_B_KEEP_ADHESION,
                element_offset: 0,
                weight: 0.5,
                min_delta: 0.0,
                max_delta: 0.0,
            ...
            // Test=0 is excluded; shader does (rng % max_value) + 1 -> [1, 12].
            MutationParamEntry {
                buffer_id: buffer_id::MODE_CELL_TYPES,
                element_offset: 0,
                weight: 8.0,
                min_delta: 0.0,
                max_delta: 0.0,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::OCULOCYTE_PARAMS,
                element_offset: 1,
                weight: 1.0,
                min_delta: 2.0,
                max_delta: 10.0,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::REGULATION_PARAMS,
                element_offset: 0,
                weight: 0.5,
                min_delta: 1.0,
                max_delta: 2.0,
            ...
            // regulation_emit_value [-1000.0, 1000.0]: signed f32 stored as bits
            MutationParamEntry {
                buffer_id: buffer_id::REGULATION_PARAMS,
                element_offset: 1,
                weight: 0.7,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::GLUEOCYTE_ENV_ADHESION,
                element_offset: 0,
                weight: 0.5,
                min_delta: 0.0,
                max_delta: 0.0,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::CHILD_MODE_INDICES,
                element_offset: 0,
                weight: 1.5,
                min_delta: 1.0,
                max_delta: 3.0,
            ...
            MutationParamEntry {
                ...
                min_value: 0.0,
                max_value: 39.0,
                data_type: data_type::CHAIN_EXTEND,
            },
            ...
            MutationParamEntry {
                ...
                min_value: 0.0,
                max_value: 39.0,
                data_type: data_type::CHAIN_CLOSE,
            },
            ...
            MutationParamEntry {
                ...
                min_value: 0.0,
                max_value: 39.0,
                data_type: data_type::LOOP_BRANCH,
            },
            ...
            MutationParamEntry {
                ...
                min_value: 0.0,
                max_value: 39.0,
                data_type: data_type::LOOP_MERGE,
            },
            ...
            MutationParamEntry {
                buffer_id: buffer_id::GENOME_INITIAL_MODE,
                element_offset: 0,
                weight: 1.5,
                min_delta: 1.0,
                max_delta: 3.0,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::GENOME_MODE_DATA,
                element_offset: 0,
                weight: 10.0,
                min_delta: 0.0,
                max_delta: 0.0,
            ...
            MutationParamEntry {
                buffer_id: buffer_id::SIGNAL_SETTINGS,
                element_offset: 0,
                weight: 0.3,
                min_delta: 1.0,
                max_delta: 3.0,
            ...
            // division_signal_threshold [0.0, 1000.0] (v0.y, element_offset 1)
            MutationParamEntry {
                buffer_id: buffer_id::SIGNAL_SETTINGS,
                element_offset: 1,
                weight: 0.5,
            ...
            // apoptosis_signal_threshold [0.0, 1000.0] (v1.x, element_offset 4)
            MutationParamEntry {
                buffer_id: buffer_id::SIGNAL_SETTINGS,
                element_offset: 4,
                weight: 0.5,
            ...
            // signal_child_a_threshold [0.0, 1000.0] (v1.w, element_offset 7)
            MutationParamEntry {
                buffer_id: buffer_id::SIGNAL_SETTINGS,
                element_offset: 7,
                weight: 0.5,
            ...
            // signal_child_b_threshold [0.0, 1000.0] (v2.w, element_offset 11)
            MutationParamEntry {
                buffer_id: buffer_id::SIGNAL_SETTINGS,
                element_offset: 11,
                weight: 0.5,
            ...
            // mode_switch_signal_threshold [0.0, 1000.0] (v3.w, element_offset 15)
            MutationParamEntry {
                buffer_id: buffer_id::SIGNAL_SETTINGS,
                element_offset: 15,
                weight: 0.5,
            ...
            MutationParamEntry {
                ...
                min_value: 8.0,
                max_value: 15.0,
                data_type: data_type::SIGNAL_WIRE,
            },
            ...
            // Structural changes should be much rarer than ordinary mutations to
            // existing modes; most evolution should tune behavior before changing
            // genome shape.
            ...
            MutationParamEntry {
                ...
                min_value: 0.0,
                max_value: 0.0,
                data_type: data_type::MODE_APPEND,
            },
            MutationParamEntry {
                buffer_id: buffer_id::GENOME_STRUCTURE,
                element_offset: 0,
                ...
                min_value: 0.0,
                max_value: 0.0,
                data_type: data_type::MODE_TRIM,
            },
        ];
        entries.extend(Self::listener_response_entries(0.3));
        entries
    }

    fn listener_response_entries(weight: f32) -> impl Iterator<Item = MutationParamEntry> {
        (0..crate::genome::SIGNAL_LISTENER_COUNT as u32).map(move |listener| MutationParamEntry {
            buffer_id: buffer_id::LISTENER_RESPONSE,
            element_offset: listener,
            weight,
            min_delta: 0.0,
            max_delta: 0.0,
            min_value: 0.0,
    ...
    pub fn set_subtle_mutations(&mut self, queue: &wgpu::Queue, subtle: bool) {
        ...
        let mut entries = if subtle {
            vec![
                ...
                // --- Regulation emission (subtle: value only, no channel changes) ---

                // regulation_emit_value [-1000.0, 1000.0]: small signed nudge
                MutationParamEntry {
                    buffer_id: buffer_id::REGULATION_PARAMS,
                    element_offset: 1,
                    weight: 0.4,
        ...
        if subtle {
            entries.extend(Self::listener_response_entries(0.2));
        }
    ...
    pub fn update_vulnerability_table(
        &mut self,
        queue: &wgpu::Queue,
        entries: Vec<MutationParamEntry>,
    ) {
    ...
    pub fn sync_genome_metadata(&mut self, queue: &wgpu::Queue, genomes: &[crate::genome::Genome]) {
        ...
        if !self.ring_initialized {
            ...
            queue.write_buffer(
                &self.genome_ring_state_buffer,
                0,
                bytemuck::cast_slice(&initial_ring_state),
            );
    ...
    pub fn rebuild_bind_groups(
        ...
        self.params_bind_group = Some(device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: self.vulnerability_table_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 2,
                ...
                wgpu::BindGroupEntry {
                    binding: 3,
                    resource: self.genome_free_ring_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 4,
        ...
        self.candidates_bind_group = Some(device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
                    resource: self.mutation_candidates_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: self.mutation_candidate_count_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 2,
                    resource: genome_ids_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 3,
        ...
        self.buffers_bind_group = Some(device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
                    resource: mode_properties_v0.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: mode_properties_v1.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 2,
                    resource: mode_properties_v2.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 3,
                    resource: mode_properties_v3.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 4,
                    resource: mode_properties_v4.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 5,
                    resource: genome_mode_data_v0.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 6,
                    resource: genome_mode_data_v1.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 7,
                    resource: genome_mode_data_v2.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 8,
                    resource: genome_mode_data_v3.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 9,
                    resource: genome_mode_data_v4.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 10,
                    resource: child_mode_indices_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 11,
                    resource: mode_cell_types_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 12,
                    resource: parent_make_adhesion_flags_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 13,
                    resource: child_a_keep_adhesion_flags_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 14,
                    resource: child_b_keep_adhesion_flags_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 15,
                    resource: glueocyte_env_adhesion_flags_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 16,
                    resource: oculocyte_params_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 17,
                    resource: self.mutation_log_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 18,
                    resource: self.mutation_log_count_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 19,
                ...
                wgpu::BindGroupEntry {
                    binding: 21,
                    resource: adhesion_settings_v0_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 22,
                    resource: adhesion_settings_v1_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 23,
                    resource: adhesion_settings_v2_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 24,
                    resource: signal_settings_v0_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 25,
                    resource: signal_settings_v1_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 26,
                    resource: signal_settings_v2_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 27,
                    resource: signal_settings_v3_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 28,
                    resource: signal_settings_v4_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 29,
                    resource: regulation_params_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 30,
                    resource: child_a_after_split_keep_adhesion_flags_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 31,
                ...
                wgpu::BindGroupEntry {
                    binding: 35,
                    resource: mode_properties_v5_buffer.as_entire_binding(),
                },
                wgpu::BindGroupEntry {
                    binding: 36,
    ...
    pub fn rebuild_collect_bind_groups(
        ...
        queue.write_buffer(
            &self.collect_params_buffer,
            0,
            bytemuck::bytes_of(&collect_params),
        );

        self.collect_input_bind_group =
            Some(device.create_bind_group(&wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    wgpu::BindGroupEntry {
                        binding: 0,
                        resource: self.collect_params_buffer.as_entire_binding(),
                    },
                    wgpu::BindGroupEntry {
                        binding: 1,
                    ...
                    wgpu::BindGroupEntry {
                        binding: 2,
                        resource: division_slot_assignments_buffer.as_entire_binding(),
                    },
                    wgpu::BindGroupEntry {
                        binding: 3,
                        resource: genome_ids_buffer.as_entire_binding(),
        ...
        self.collect_output_bind_group =
            Some(device.create_bind_group(&wgpu::BindGroupDescriptor {
    ...
    pub fn rebuild_gc_bind_group(&mut self, device: &wgpu::Device, queue: &wgpu::Queue) {
        ...
        self.gc_bind_group = Some(device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry {
                    binding: 4,
                    resource: self.gc_params_buffer.as_entire_binding(),
                },
            ],
        }));
    }
    ...
    pub fn rebuild_ref_count_sync_bind_group(
        ...
        self.ref_count_sync_bind_group =
            Some(device.create_bind_group(&wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    wgpu::BindGroupEntry {
                        binding: 0,
                        resource: self.ref_count_sync_params_buffer.as_entire_binding(),
                    },
                    wgpu::BindGroupEntry {
                        binding: 1,
                        resource: genome_ids_buffer.as_entire_binding(),
    ...
    pub fn dispatch(
        ...
        let (Some(params_bg), Some(candidates_bg), Some(buffers_bg)) = (
            ...
            &self.candidates_bind_group,
            &self.buffers_bind_group,
        ) else {
        ...
        if should_run_gc {
            ...
            if self.mode_offset_reset_bind_group.is_none() {
                ...
                self.mode_offset_reset_bind_group =
                    Some(device.create_bind_group(&wgpu::BindGroupDescriptor {
...
mod tests {
    ...
    fn default_vulnerability_table_prefers_existing_mode_mutations() {
        ...
        let structural_weight: f32 = entries
            .iter()
            .filter(|entry| entry.buffer_id == buffer_id::GENOME_STRUCTURE)
            .map(|entry| entry.weight)
            .sum();
        let existing_mode_weight: f32 = entries
            .iter()
            .filter(|entry| entry.buffer_id != buffer_id::GENOME_STRUCTURE)
            .map(|entry| entry.weight)
            .sum();
        ...
        assert!(
            ...
            "append/trim mutations should remain available"
        );
        assert!(
            existing_mode_weight > structural_weight * 20.0,
            "existing-mode mutations should dominate append/trim mutations"
        );

        let has_append = entries.iter().any(|entry| {
            entry.buffer_id == buffer_id::GENOME_STRUCTURE
                && entry.data_type == data_type::MODE_APPEND
                && entry.weight > 0.0
        });
        let has_trim = entries.iter().any(|entry| {
            entry.buffer_id == buffer_id::GENOME_STRUCTURE
                && entry.data_type == data_type::MODE_TRIM
                && entry.weight > 0.0
        });
        assert!(has_append, "mode append mutation should be present");
        assert!(has_trim, "mode trim mutation should be present");

        let listener_entries: Vec<_> = entries
            .iter()
            .filter(|entry| entry.buffer_id == buffer_id::LISTENER_RESPONSE)
            .collect();
        assert_eq!(
            listener_entries.len(),
            crate::genome::SIGNAL_LISTENER_COUNT,
            "every signed listener must remain independently mutable"
        );
        assert!(
            entries.len() <= 128,
            "mutation table exceeds GPU allocation"
        );
    }
