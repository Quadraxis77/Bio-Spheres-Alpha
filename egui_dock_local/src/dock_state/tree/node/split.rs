...
pub struct SplitNode {
    ...
    /// Optional absolute minimum size in pixels for the left/top child.
    /// When set, this overrides the fraction-based sizing to enforce a minimum pixel size.
    #[cfg_attr(feature = "serde", serde(default))]
    pub absolute_size_left: Option<f32>,
}
